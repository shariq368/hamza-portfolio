...
import SvgCurve from "../visualEffects/Svgeffect";
import Svgeffect from "../visualEffects/Svgeffect";
import { HeadingAnimatedSvg } from "./Headinganimated";
...
<div className="outline-none flex flex-col justify-start shrink-0 opacity-5 transform -top-32 2xl:-top-24 w-[71px] flex-none h-auto left-4 lg:left-12 absolute whitespace-pre">
    <h2 className="font-PixelFont text-[180px] text-center text-primary-foreground relative">
